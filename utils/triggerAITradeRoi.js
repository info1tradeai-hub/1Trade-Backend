...
export const triggerAITradeRoi = async (req, res) => {
  try {
    ...
    //added this for avoid duplicate roi entry
    let roiInserted = false;
    ...
    try {
      ...
      // 🔕 SILENT SKIP FOR DUPLICATE TRADE
      if (err.code === 11000) {
        // kuch mat karo — duplicate request ignore
        roiInserted = false;
      } else {
        throw err;
      }
